...
package com.jane.app.api.common.config;
...
class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache("sample", initConfiguration(Duration.ONE_DAY));
     ...
     * <p>
     * Frogin the configuration object that is provided by the JCache API standard, there is only a very limited set of
